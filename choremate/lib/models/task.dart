...
class Task {
  ...
  String _task, _date, _time, _status, _assignment, _assignmentUID;
  DateTime _dateTime;
  //User _user;

  Task(this._task, this._date, this._time, this._status, this._assignment,
      this._choreID, this._assignmentUID, this._choreIDUser, this._dateTime);
  Task.withId(
      this._id,
      this._task,
      this._date,
